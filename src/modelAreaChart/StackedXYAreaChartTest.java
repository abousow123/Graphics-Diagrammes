...
public class StackedXYAreaChartTest extends ApplicationFrame {
     ...
     */
    public StackedXYAreaChartTest(String title) {
        super(title);
...
//        plot.setRenderer(0, renderer);        
    ...
    public static void main(String[] args) {
        StackedXYAreaChartTest demo = new StackedXYAreaChartTest(
            "Stacked XY Area Chart Test");
        demo.pack();
