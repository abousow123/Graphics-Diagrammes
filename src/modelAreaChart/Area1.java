	...
	public Area1() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				JFreeChart chart = createAriaChart(createDatasetLine()) ;
				...
				if(rdbtnNewRadioButton_1.isSelected()){
					...
					JFreeChart chart = createStackedAreaChart(createDataset()) ;
					ChartPanel chartPanel = new ChartPanel(chart) ;
					chartPanel.setBounds(10, 11, 500, 440);
	 ...
	 private  TableXYDataset createDataset() {
	        ...
	        s1.add(new Integer(textField_2.getText()), new Integer(textField_3.getText()));
	        s1.add(new Integer(textField_4.getText()), new Integer(textField_5.getText()));
	        s1.add(new Integer(textField_6.getText()), new Integer(textField_7.getText()));
	        
	        dataset.addSeries(s1);
	        
	        XYSeries s2 = new XYSeries(textField_8.getText(), true, false);
	        s2.add(new Integer(textField_9.getText()), new Integer(textField_10.getText()));
	        s2.add(new Integer(textField_11.getText()), new Integer(textField_12.getText()));
	        s2.add(new Integer(textField_13.getText()), new Integer(textField_14.getText()));
	 ...
	 public JFreeChart createAriaChart(XYDataset dataset){
		 JFreeChart chart = ChartFactory.createXYAreaChart(textField.getText(),"X", "Y", dataset, PlotOrientation.VERTICAL, true, true, false) ;
	 ...
	 private JFreeChart createStackedAreaChart(TableXYDataset dataset) {

	        JFreeChart chart = ChartFactory.createStackedXYAreaChart(
	        		textField.getText(),  // chart title
