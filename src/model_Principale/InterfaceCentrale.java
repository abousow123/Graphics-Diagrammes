...
public class InterfaceCentrale extends JFrame {
	...
	ArrayList<String> tabDonneeX ;
	ArrayList<Double> tabDonneeY ;
	...
	public InterfaceCentrale() {
		...
		panel.setBorder(new TitledBorder(new BevelBorder(BevelBorder.RAISED, null, null, null, null), "Param\u00E9tre Graphe", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(0, 0, 255)));
		panel.setToolTipText("sdsd");
		panel.setBounds(128, 11, 555, 252);
		contentPane.add(panel);
		panel.setLayout(null);
		
		JComboBox comboBox = new JComboBox(typeGraphe);
		...
		panel_1.setBorder(new TitledBorder(UIManager.getBorder("TitledBorder.border"), "Donn\u00E9es graphique", TitledBorder.LEADING, TitledBorder.TOP, null, Color.BLUE));
